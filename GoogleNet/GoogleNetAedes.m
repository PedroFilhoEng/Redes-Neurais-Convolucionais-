...
% validation.
%unzip('MerchData.zip');
imagens = imageDatastore('C:\Users\PF\Documents\treinogooglenet\imgLenet','IncludeSubfolders',true,'LabelSource','foldernames','FileExtensions',{'.jpg'});
images.ReadFcn = @(loc)imresize(imread(loc),[224,224,3]);
